...
const extern std::unordered_map< long long int, const handDat > FKFH;
const extern std::unordered_map< long long int, const handDat > Fl;
const extern std::unordered_map< long long int, const handDat > RemHands;
