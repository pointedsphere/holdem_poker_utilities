...
with open(outFile, "a") as f:
    f.write("int primefinderFace(int AP1, int AP2, int AP3, int AP4, int AP5, int AP6, int AP7,\\\n")
    ...
    f.write("  /*\n")
    f.write("  We first check for the royal and straight flush, as this allows us to dicard the best hands outright.\n\n")
    ...
    f.write("  \n\n\n\n\n/*\n")
    f.write("  We now check for a flush, which uses only the product of the prime suit values.\n")
    f.write("  */\n\n")
